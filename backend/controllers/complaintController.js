...
const buildEmail = ({ name, complaintId, title, category, priority, assignedTo }) => `
<!DOCTYPE html>
<html>
...
export const createComplaint = async (req, res) => {
  try {
    ...
    const assignedTo = staffList.length > 0 ? staffList[0].name : suggestedRole;
    ...
    if (studentRows.length > 0) {
      sendEmail(
        ...
        buildEmail({ name:studentRows[0].name, complaintId, title, category, priority, assignedTo })
