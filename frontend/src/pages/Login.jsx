      ...
      <div className="lg-card">
        ...
        <div className="lg-left">
          ...
          <p className="lg-left-sub">
            Smart Complaint Redressal System powered
        ...
        <div className="lg-right">
          ...
          <div className="lg-portals">
            ...
            <div className="lg-portal-btns">
              ...
              <button
                className="lg-portal-btn lg-portal-admin"
                onClick={() =>
              ...
              <button
                className="lg-portal-btn lg-portal-staff"
                onClick={() =>
