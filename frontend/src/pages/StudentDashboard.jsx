...
// Vercel production URL comes from environment variable.
...
export default function StudentDashboard() {
  ...
  const fetchDashboard = useCallback(async () => {
    try {
      ...
      const r = await fetch(
        `${BACKEND}/api/complaints/student-dashboard`,
        {
          headers: {
  ...
  const fetchComplaints = useCallback(async () => {
    try {
      ...
      const r = await fetch(
        `${BACKEND}/api/complaints/my-complaints`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    try {
      ...
      if (d.success) {
        const notifs = d.complaints
          .filter(
            (c) => c.status !== "Pending" || c.assigned_to
          )
          .map((c) => ({
            id: c.id,
  ...
  const submitFeedback = async (id) => {
    ...
    try {
      ...
      const r = await fetch(
        `${BACKEND}/api/complaints/${id}/rating`,
        {
          method: "POST",
          headers: {
  ...
  const downloadReport = async () => {
    ...
    try {
      ...
      alert(
        "Error downloading report. Please check your connection."
      );
    }
  ...
  const sentiment = (s) =>
    s === "Positive" ? (
      <span className="sd-sent sd-sent-pos">
        😊 Positive
      </span>
    ) : s === "Negative" ? (
      <span className="sd-sent sd-sent-neg">
        😞 Negative
      </span>
    ) : s === "Neutral" ? (
      <span className="sd-sent sd-sent-neu">
        😐 Neutral
      </span>
    ) : null;
  ...
  const timeAgo = (dateStr) => {
    const diff =
      now.getTime() - new Date(dateStr).getTime();
    ...
    <div className="sd-root">
      ...
      <header className="sd-topbar">
        ...
        <div className="sd-topbar-l">
          ...
          <div>
            <div className="sd-top-title">
              AI College Complaints Redressal System
            </div>

            <div className="sd-top-sub">
              Student dashboard
            </div>
          </div>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    padding: "12px 16px",
                    background:
                      "linear-gradient(90deg,#1e3a5f,#312e81)",
                  }}
                >
      ...
      <div className="sd-body">
        ...
        <div className="sd-welcome">
          ...
          <div className="sd-welcome-text">
            ...
            <div className="sd-welcome-sub">
              Here's a summary of your complaints and
        ...
        <div className="sd-tbl-card">
          ...
          <div className="sd-tbl-head">
            ...
            <div className="sd-tbl-title">
              📋 My Complaints
            </div>

            <div className="sd-tbl-count">
